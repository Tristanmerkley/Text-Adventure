...
public class CommandWords {
  ...
  public static final HashSet<String> commands = new HashSet<String>(Arrays.asList("quit", "help", "eat", "drink", "take", "drop", "inspect", "inventory", "look", "bowl", "place", "open", "time", "unlock", "dig", "read", "save", "load"));
